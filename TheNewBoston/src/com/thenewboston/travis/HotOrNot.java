...
public class HotOrNot {
	...
	public final static String KEY_HOTNESS = "persons_hotness";
	
	private final static String DATABASE_NAME = "HotOrNotdb";
	private final static String DATABASE_TABLE = "peopleTable";
